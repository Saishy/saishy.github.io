...
TinyAttack is an online multiplayer roguelike game. (Unity3D)
...
A small project that generates random dungeons based on the rules of the tabletop D&D game. (Unity3D)
...
I worked as the solo programmer for this indie game. (UDK)
...
Facebook social game. (HTML + Ruby)
...
Implementation of old-school platformer colliders. (Unity3D)
